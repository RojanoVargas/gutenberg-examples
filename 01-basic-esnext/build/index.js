...
const Edit = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Hello World, step 1 (from the editor). - hellooooooooooooooooooooooooo', 'gutenberg-examples'));
};
...
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"gutenberg-examples/example-01-basic-esnext","title":"Example: Basic (ESNext)","textdomain":"gutenberg-examples","icon":"universal-access-alt","category":"layout","example":{},"editorScript":"file:./build/index.js"}');
